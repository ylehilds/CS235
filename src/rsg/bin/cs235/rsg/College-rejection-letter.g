...
{
<start>
<salutation> <Intro> <beatingAroundTheBush> <contrast> <droppingTheBomb> <reason> <closing> ;
<salutation> <Intro> <beatingAroundTheBush> <contrast> <droppingTheBomb> <reason> <closing> ;
<salutation> <Intro> <beatingAroundTheBush> <contrast> <droppingTheBomb> <reason> <cushion> <closing> ;
}
...
<contrastTransition>
However, ;
However, as you could probably tell from the thickness of the envelope this came in ;
Unfortunately, ;
